...
if( is_admin() ){
	...
	*/
		...
		function tie_rate_pointer_print_scripts() {
			...
			$pointer_content .= "<p><a href=\'http://themeforest.net/downloads\' target=\'_blank\'>".__( "If you like the theme, please don\'t forget to rate it :)", "tie")."</a></p>";
		?>
	...
	function tie_admin_register() {
		...
		wp_register_script( 'tie-admin-main', get_template_directory_uri() . '/framework/admin/js/tie.js', array( 'jquery', 'jquery-ui-tooltip' ), $ver, false );
		wp_register_script( 'tie-admin-icon-picker', get_template_directory_uri() . '/framework/admin/js/icon-picker.js', array( 'jquery' ), $ver, false );
		wp_register_script( 'tie-admin-colorpicker', get_template_directory_uri() . '/framework/admin/js/colorpicker.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-mouse', 'jquery-ui-sortable', 'jquery-ui-slider' ), $ver, false );

		wp_register_style( 'tie-style', get_template_directory_uri().'/framework/admin/style.css', array(), $ver, 'all' );
		wp_register_style( 'tie-fonts', get_template_directory_uri().'/framework/admin/fonts.css', array(), $ver, 'all' );
		wp_register_style( 'tie-fontawesome', get_template_directory_uri().'/fonts/fontawesome/font-awesome.min.css', array(), $ver, 'all' );
