		...
		?>
			<li class="arq-lite-instagram">
				<a href="https://instagram.com/<?php echo $arq_lite_options['social']['instagram']['id'] ?>"<?php echo $new_window ?>>
					...
					<span><?php echo arq_lite_instagram_count() ?></span>
					<small><?php echo $text; ?></small>
				</a>
			</li>
		<?php
...
function arq_lite_instagram_count() {
	...
	if( ! empty( $arq_lite_options['social']['instagram']['number'] ) ){
		return $arq_lite_options['social']['instagram']['number'];
	}
						...
						<div class="inside">
							<table class="links-table" cellpadding="0">
								<tbody>
									...
									<tr>
										<th scope="row"><label for="social[instagram][number]"><?php esc_html_e( 'Number of Followers', 'tie' ) ?></label></th>
										<td><input type="text" name="social[instagram][number]" id="social[instagram][number]" value="<?php if( ! empty($arq_lite_options['social']['instagram']['number']) ) echo esc_attr( $arq_lite_options['social']['instagram']['number'] ) ?>"></td>
									</tr>
								</tbody>
							</table>

							<div>
								<strong><?php _e( 'Need Help?' , 'arqam-lite' ) ?></strong><p><em><?php _e( 'Enter Your Instagram Username and the number of followers.', 'tie' ) ?></em></p>
								<p><em><a href="https://developers.facebook.com/docs/instagram-basic-display-api/reference/user#edges" target="_blank"><?php _e( 'Instagram has removed the number of followers from their API.', 'tie' ) ?></a></em></p>
							</div>
